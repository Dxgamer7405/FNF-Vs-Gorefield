...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			['BitfoxOriginal',				'bitfox',			'Main Muscian of Gorefield',				'https://twitter.com/BitfoxOriginal',			'ffcc97'],
			['Tok',				'tok',			'Main Charter of Gorefield',				'https://twitter.com/ThatOne_Kid39',			'7e789c'],
			[''],
			['Special Thanks'],
